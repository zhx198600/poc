...
BeatPicker.prototype = {
    ...
    ar: function () {
        var a = this;
        this.view.alwaysVisible || (a.k.css("display", "block"), $("html,body").on(this.view.hideOn, function (b) {
            !a.v && a.hide()
    ...
    at: function (a, b) {
        var c = this.by(a), d = b && b.x || this.view.position[0], e = b && b.y || this.view.position[1], f = this,
            g = {
                rightTop: function () {
                    d = this._rightCommon();
        ...
        if (isNaN(d) && isNaN(e)) {
            var h = d, k = e.substr(0, 1).toUpperCase() + this.view.position[1].substr(1),
                h = "*" === d && "*" === e ? "**" : "*" == e ? h : h + k;
    ...
    au: function (a) {
        ...
        }, this.cq(this.events.select, d)) : this.selectionRule.range && (this.t ? (this.o = b, this.bi(!0)) : this.u && (this.r = b, this.bi(!1)), this.selectionRule.rangeDisableSelect ||
    ...
    aw: function (a,
                  b, c) {
        var d = {YYYY: "FullYear", MM: "Month", DD: "Date"}, e = this.currentDate["get" + d[b]](),
    ...
    by: function (a) {
        var b = $(window).outerHeight(), c = $(window).outerWidth(),
            d = $(a)[this.view.alwaysVisible ? "position" : "offset"]().top,
            e = $(a)[this.view.alwaysVisible ? "position" : "offset"]().left, f = $(a).outerHeight();
        a = $(a).outerWidth();
